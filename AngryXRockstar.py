...
def main():
	...
	while True:
		bots = random._urandom(int(random.randint(5025,65530)))
		bots = random._urandom(int(random.randint(5025,65531)))
		avi = random._urandom(int(random.randint(5025,60334516)))
